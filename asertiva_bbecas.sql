...
--
-- Host: localhost    Database: asertiva_bbecas
-- ------------------------------------------------------
...
--
-- Table structure for table `beca_ocde`
--

DROP TABLE IF EXISTS `beca_ocde`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `beca_ocde` (
  ...
  PRIMARY KEY (`id`),
  KEY `beca_ocde_beca_id_foreign` (`beca_id`),
  KEY `beca_ocde_ocde_id_foreign` (`ocde_id`),
  CONSTRAINT `beca_ocde_beca_id_foreign` FOREIGN KEY (`beca_id`) REFERENCES `becas` (`id`) ON DELETE CASCADE,
  CONSTRAINT `beca_ocde_ocde_id_foreign` FOREIGN KEY (`ocde_id`) REFERENCES `ocdes` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `beca_ocde`
--

LOCK TABLES `beca_ocde` WRITE;
/*!40000 ALTER TABLE `beca_ocde` DISABLE KEYS */;
INSERT INTO `beca_ocde` VALUES (1,1,14,NULL,NULL),(2,1,15,NULL,NULL),(3,1,35,NULL,NULL),(4,1,36,NULL,NULL);
/*!40000 ALTER TABLE `beca_ocde` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `beca_ods`
--

DROP TABLE IF EXISTS `beca_ods`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `beca_ods` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `beca_id` bigint unsigned NOT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `beca_ods_beca_id_foreign` (`beca_id`),
  KEY `beca_ods_ods_id_foreign` (`ods_id`),
  CONSTRAINT `beca_ods_beca_id_foreign` FOREIGN KEY (`beca_id`) REFERENCES `becas` (`id`) ON DELETE CASCADE,
  CONSTRAINT `beca_ods_ods_id_foreign` FOREIGN KEY (`ods_id`) REFERENCES `odss` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `beca_ods`
--

LOCK TABLES `beca_ods` WRITE;
/*!40000 ALTER TABLE `beca_ods` DISABLE KEYS */;
INSERT INTO `beca_ods` VALUES (1,1,2,NULL,NULL),(2,1,3,NULL,NULL),(3,1,15,NULL,NULL),(4,1,17,NULL,NULL);
/*!40000 ALTER TABLE `beca_ods` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `becas` (
  ...
  `obligation` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `becas_country_id_foreign` (`country_id`),
  CONSTRAINT `becas_country_id_foreign` FOREIGN KEY (`country_id`) REFERENCES `countrys` (`id`) ON DELETE SET NULL
...
INSERT INTO `becas` VALUES (1,'MI beca','Nombre de la beca','Resumen de beca','parcial','es obligatoria','Buenos Aires','2023-11-01','2023-11-30',565767567,1,'-','https://www.convocatoriasdetrabajo.com/oportunidad-laboral-practicas-sunarp-ciencias-computacion-ingenieria-software-noviembre-2023-341142.html','uploads/1700009899_Lab 03-Modelado y conexion a base de datos.pdf',9,'2023-11-15 00:58:19','2023-11-15 00:58:19');
...
INSERT INTO `migrations` VALUES (1,'2014_10_12_000001_create_roles_table',1),(2,'2014_10_12_000002_create_users_table',1),(3,'2014_10_12_100000_create_password_resets_table',1),(4,'2019_08_19_000000_create_failed_jobs_table',1),(5,'2019_12_14_000001_create_personal_access_tokens_table',1),(6,'2023_11_11_201749_create_ocdes_table',1),(7,'2023_11_11_201800_create_odss_table',1),(8,'2023_11_11_201838_create_countrys_table',1),(9,'2023_11_11_201854_create_becas_table',1),(10,'2023_11_11_201908_create_beca_ocde_table',1),(11,'2023_11_11_201923_create_beca_ods_table',1);
...
INSERT INTO `users` VALUES (1,'Admin','Admin','entiende@piu.com','99090790','Mi trabajo','Mi estudio','Otro','2000-01-01',NULL,'$2y$10$egYjkmD7ALsiUERK/nCvAuqAiqkEnblt0zzLPATY64GVrVxB0AF2e',1,NULL,'2023-11-15 00:53:05','2023-11-15 00:53:05');
...
-- Dump completed on 2023-11-15  1:17:04
